              ...
              <tbody>
                ...
                <tr v-for="enquiry in filteredEnquiries">
                  ...
                  <td class="center">
                    ...
                    <a target="_blank" href="{{ url('admin/view-order-invoice/'.$order->id)}}" class="btn btn-success btn-mini">View Order Invoice</a><br><br>
                    <a target="_blank" href="{{ url('admin/invoicePDF/'.$order->id)}}" class="btn btn-success btn-mini">Download Invoice</a> 
                  </td>
                </tr>
                @endforeach
              </tbody>
