                ...
                <tr class="gradeX">
                  ...
                  <td class="center">
                    ...
                    <a href="{{ url('/admin/edit-product/'.$product->id) }}" class="btn btn-primary btn-mini">Edit</a> 
                                  <a href="{{ url('/admin/delete-product/'.$product->id) }}" id="delProduct" rel="{{ $product->id }}" rel1="delete-product" href="javascript:" class="btn btn-danger btn-mini deleteRecord">Delete</a>
                        ...
                        <div id="myModal{{ $product->id }}" class="modal hide">
                          ...
                          <div class="modal-body">
                            ...
                            <p>Product Color: {{ $product->quantity }}</p>
